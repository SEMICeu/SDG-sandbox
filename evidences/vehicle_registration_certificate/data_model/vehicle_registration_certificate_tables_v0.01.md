...
|--------------------------|----------------------------|----------------------------------------------------------------------------------------------------------------|--------------------|----------------|
|     registration number  |     Identifier             |     An unambiguous reference to the Vehicle Registration Certificate.                                          |     [1..1]         | N/A |
|     certifies            |     Vehicle                |     The Vehicle that is the subject of the Certificate.                                                        |     [1..1]         | N/A |
|     validity date        |     Period                 |     The date on which the Vehicle Registration Certificate was issued.                                         |     [1..1]         | N/A |
|     registration date    |     date                   |     The date on which the Vehicle was registered.                                                              |     [1..1]         | N/A |
|     issuing authority    |     Public Organisation    |     A Public Organisation with official authority in charge of issuing the Vehicle Registration Certificate.   |     [1..1]         | N/A |
|     vehicle owner        |     Agent                  |     The owner of the Vehicle.                                                                                  |     [0..1]         | N/A |
|     vehicle legal user           |     Agent                  |     The legal user of the Vehicle.                                                                             |     [0..*]         | N/A |
|     holder               |     Agent                  |     The holder of the Vehicle Registration Certificate.                                                        |     [1..1]         | N/A |
