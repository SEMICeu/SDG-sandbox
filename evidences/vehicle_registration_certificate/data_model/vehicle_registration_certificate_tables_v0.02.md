...
|     start registration date |     Date                   |     Start date of registration in the Member State.                     																											 |     [1..1]         | N/A                                                                                  |
|     end registration date   |     Date                   |     End date of registration in the Member State. (Is populated if the vehicle has been de-registered in the Member State.)    													 |     [0..1]         | N/A                                                                                  |
...
|     vehicle owner           |     Agent                  |     Natural person or legal person that is the legal owner of the vehicle (i.e. the entity that has bought the vehicle, and has the right to sell it).                              |     [0..1]         | N/A                                                                                  |
...
|     make                                         |     String               |     The make of the Vehicle, e.g. Ford, Opel, Renault, etc.                                    																	    |     [1..1]         | N/A                                               |
|     type                                         |     String               |     The type of the Vehicle as described in B. of Annex II of 2007/46/EC.                                              											    |     [1..1]         | N/A                                               |
|     type variant                                 |     String               |     The type variant of the Vehicle as described in B. of Annex II of 2007/46/EC.                                        											|     [0..1]         | N/A                                               |
|     type version                                 |     String               |     The type version of the Vehicle as described in B. of Annex II of 2007/46/EC.                                       											|     [0..1]         | N/A                                               |
|     commercial name                              |     String               |     The commercial name of the Vehicle, e.g. Focus, Astra, Megane.                                            														|     [1..*]         | N/A                                               |
...
**Definition**: The event when a Vehicle's compliance to the technical specifications is verified.
...
|     attribute                         |     expected type |     definition                                                                                                               |     cardinality   | code list |
|---------------------------------------|-------------------|------------------------------------------------------------------------------------------------------------------------------|-------------------|-----------|
|     identifier                        |     Identifier    |     The identifier relation is used to link a Public Organisation to any formally issued Public Organisation for that Agent. |     [1..*]        | N/A       |
