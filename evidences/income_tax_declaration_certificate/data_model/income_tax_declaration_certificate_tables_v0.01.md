...
|     issuing authority    |     Public Organization    |     A Public Organisation with official authority in charge of issuing the Tax Declaration Certificate. |     [1..1]         |
...
|     amount               |     Float                  |     The quantitative value of the Monetary Amount.                                                      |     [1..1]         |
...
|     attribute        |             expected type             |     definition                                                                                                                                                                                                                                                                                                                                                                                       |    cardinality     |
|----------------------|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------|
|     preferred label  |     Public Organization Label         |     As defined in the ORG Ontology, a preferred label is used to provide the primary, legally recognised name of the organization. An organization may only have one such name in any given language. Primary names may be provided in multiple languages with multiple instances of the preferred label property.                                                                                   |    [1..*]          |
...
**Definition**: Primary name referring to a public organization, in a given language.

|     attribute        |             expected type             |     definition                                                                                                                                                                                                                                                                                                                                                                                       |    cardinality     |
|----------------------|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------|
|     label            |     string         |     Primary name given to the organization, in the given language.                                                                                   |    [1..1]          |
|     language         |     string         |     The language identifier, according to the ISO 639-1 code.              |    [1..1]          |
