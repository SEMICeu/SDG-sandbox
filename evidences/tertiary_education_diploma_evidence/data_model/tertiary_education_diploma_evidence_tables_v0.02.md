...
This page relates to [version (v0.02)](tertiary_education_diploma_evidence_diagram_v0.02.png) of the model.
...
|     qualification name |     Text	                 |   Full name of the qualification, at least in the original language(s) as it is styled in the original qualification.  |     [1..*]         |  N/A         																																																		       |
...
**Definition**: Any degree, diploma or other evidence issued by a competent authority attesting the successful completion of a recognised programme of study of tertiary education.

**Subclass of**: Tertiary Education Evidence

|     attribute               |     expected type                                    |    definition                                                    		                                                                |     cardinality    | code list |
|-----------------------------|------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|--------------------|-----------| 
|     academic program        |     Text                                             |    The set of educational components leading to the award of a degree to a student after successful completion of all the requirements.  |     [1..1]         | N/A       |
|     level of distinction    |     Code                                             |    Indication of the level of distinction with which an academic degree has been earned.                                                 |     [0..1]         | TBD       |
|     overall grade           |     Grade                                            |    A mark indicating a degree of accomplishment.                                                                                         |     [1..1]         | N/A       |
|     teaching permission     |     Code                                             |    Eligibility of the Person to teach a certain ISCED 2011 level.                                                                        |     [0..*]         | [ISCED 2011 Levels]( http://uis.unesco.org/sites/default/files/documents/isced-2011-operational-manual-guidelines-for-classifying-national-education-programmes-and-related-qualifications-2015-en_1.pdf)  |
...
| attribute                   |     expected type               |     definition                                                 		                                                         |   cardinality      | code list 																																																			  |
|-----------------------------|---------------------------------|--------------------------------------------------------------------------------------------------------------------------------|--------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| 
| academic programme language |     Code                        |     The main language in which the academic programme was given.                                                               |   [0..1]           | [Language](http://publications.europa.eu/resource/dataset/language)  																																				  |
...
| main field of study         |     Code                        |     Major branch of knowledge of the respective programme, that is taught and researched as part of the tertiary education.    |   [0..*]           | [ISCED 2013](http://uis.unesco.org/sites/default/files/documents/international-standard-classification-of-education-fields-of-education-and-training-2013-detailed-field-descriptions-2015-en.pdf)       			  |
| mode of study               |     Code                        |     The way the program is studied, e.g. full-time, part-time, intermittent/sandwich, e-learning, distance, etc.               |   [0..1]           | TBC      																																																			  |
...
| total credits               |     Float                       |     Total student workload described in terms of ECTS credits.                                                                 |   [0..1]           | N/A                                                                                                                                                                                                                   |
...
|     field of study           |     Code        		    |     Branch of knowledge of the respective programme, that is taught and researched as part of the tertiary education.                         			  |     [0..*]         | [ISCED 2013](http://uis.unesco.org/sites/default/files/documents/international-standard-classification-of-education-fields-of-education-and-training-2013-detailed-field-descriptions-2015-en.pdf)        |
