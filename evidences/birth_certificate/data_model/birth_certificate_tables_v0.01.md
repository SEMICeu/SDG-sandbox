...
This page is not up to date and relates to this version of the model [birth_certificate_diagram_v0.10.pdf](https://github.com/SEMICeu/SDG-sandbox/blob/master/evidences/birth_certificate/data_model/birth_certificate_diagram_v0.10.pdf). Friday `04/09/2020`, this page will be updated according to this version of the model [birth_certificate_diagram_v0.11.pdf](https://github.com/SEMICeu/SDG-sandbox/blob/master/evidences/birth_certificate/data_model/birth_certificate_diagram_v0.11.pdf)
...
|     attribute    |     expected type |     definition                                            |     cardinality    |
|------------------|-------------------|-----------------------------------------------------------|--------------------|
|     parent one   |     Person        |     The first parent of the child.                        |     [0..1]         |
|     parent two   |     Person        |     The second parent of the child.                       |     [0..1]         |
